...
public class HoodSubsystem extends SubsystemBase {
  ...
  private final double kF = PIDConstants.kHoodkF;
  ...
  public HoodSubsystem() {
    ...
    SmartDashboard.putNumber("Hood Reference", 0);
  }
  ...
  public void setHoodDegrees(double reference){
    ...
    reference = SmartDashboard.getNumber("Hood Reference", 0);

    if(reference < 0){
      newkF = -newkF;
    }

    m_pid.setReference(degreesToSpark(reference), ControlType.kPosition, 0, newkF, ArbFFUnits.kVoltage);
  }
